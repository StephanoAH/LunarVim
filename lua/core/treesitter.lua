...
M.setup = function()
	...
	-- }
	-- Custom text objects
	-- local textobj_prefixes = LV.treesitter.textobj_prefixes
	-- local textobj_suffixes = LV.treesitter.textobj_suffixes
	-- local textobj_sel_keymaps = {}
	-- local textobj_swap_keymaps = {}
	-- local textobj_move_keymaps = {
	--   enable = LV.plugin.ts_textobjects,
	...
	--   end
	-- end
	-- vim.g.ts_hint_textobject_keys = LV.treesitter.hint_labels -- Requires https://github.com/mfussenegger/nvim-ts-hint-textobject/pull/2
	--
	...
	treesitter_configs.setup(LV.treesitter)
end
