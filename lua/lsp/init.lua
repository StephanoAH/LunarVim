...
if LV.lsp.default_keybinds then
	...
	vim.cmd(
		"nnoremap <silent> <C-p> :lua vim.lsp.diagnostic.goto_prev({popup_opts = {border = LV.lsp.popup_border}})<CR>"
	)
	vim.cmd(
		"nnoremap <silent> <C-n> :lua vim.lsp.diagnostic.goto_next({popup_opts = {border = LV.lsp.popup_border}})<CR>"
	)
...
vim.lsp.handlers["textDocument/publishDiagnostics"] = vim.lsp.with(vim.lsp.diagnostic.on_publish_diagnostics, {
	virtual_text = LV.lsp.diagnostics.virtual_text,
	signs = LV.lsp.diagnostics.signs,
	underline = LV.lsp.document_highlight,
})

vim.lsp.handlers["textDocument/hover"] = vim.lsp.with(vim.lsp.handlers.hover, {
	border = LV.lsp.popup_border,
})
...
local function lsp_highlight_document(client)
	if LV.lsp.document_highlight == false then
...
function lsp_config.preview_location(location, context, before_context)
	...
	return vim.lsp.util.open_floating_preview(contents, filetype, { border = LV.lsp.popup_border })
end
...
function lsp_config.common_on_attach(client, bufnr)
	if LV.lsp.on_attach_callback then
		LV.lsp.on_attach_callback(client, bufnr)
	end
...
function lsp_config.tsserver_on_attach(client, _)
	...
	ts_utils.setup({
		...
		-- eslint_bin = LV.lang.tsserver.linter,
		eslint_config_fallback = nil,
		eslint_enable_diagnostics = true,

		-- formatting
		enable_formatting = LV.lang.tsserver.autoformat,
		formatter = LV.lang.tsserver.formatter.exe,
...
--   python = {
--     analysis = {
--       typeCheckingMode = LV.lang.python.analysis.type_checking,
--       autoSearchPaths = LV.lang.python.analysis.auto_search_paths,
--       useLibraryCodeForTypes = LV.lang.python.analysis.use_library_code_types,
--     },
--   },
-- },
