...
M.setup = function()
	...
	local get_linter_instance = function()
		...
		local local_instance = root_dir .. "/node_modules/.bin/" .. LV.lang.tsserver.linter
		if vim.fn.executable(local_instance) == 1 then
			return local_instance
		end
		return LV.lang.tsserver.linter
	end

	local tsserver_args = {}
	local formattingSupported = false

	if LV.lang.tsserver.linter == "eslint" or LV.lang.tsserver.linter == "eslint_d" then
		local eslint = {
			...
			lintSource = LV.lang.tsserver.linter,
